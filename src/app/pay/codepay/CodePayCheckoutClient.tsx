    ...
    <div className="min-h-screen flex flex-col items-center justify-between py-10 px-4 bg-slate-100">
      ...
      <div className="w-full max-w-[420px] rounded-3xl shadow-2xl overflow-hidden bg-white">
        ...
        <div className="p-6 space-y-5">
          ...
          {/* ── Feedback messages ── */}
          {errorMessage && (
            <div className="flex items-start gap-2.5 p-3.5 bg-red-50 border border-red-100 text-red-700 rounded-2xl text-xs font-semibold leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <form onSubmit={handleVerify} className="space-y-3">
                <div>
                  ...
                  />
                  <p className="text-[10px] text-slate-400 mt-1 text-center">Found in your {cfg.label} SMS receipt after sending.</p>
                </div>
                ...
                <button
                  ...
                  disabled={isLoading}
                  style={{ backgroundColor: headerBg }}
                  className="w-full py-3.5 text-white rounded-xl text-xs font-extrabold uppercase tracking-wider hover:opacity-90 disabled:opacity-50 transition cursor-pointer flex items-center justify-center gap-2"
                >
                  {isLoading ? (
                    <>
