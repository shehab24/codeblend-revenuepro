      ...
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-16">
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: "🛡️", title: "রিয়েল-টাইম কুরিয়ার ফ্রড ডিটেকশন", desc: "কাস্টমারের ফোন নাম্বার দিয়ে Steadfast, Pathao, RedX সহ সকল কুরিয়ারের অতীত পার্সেল ডেলিভারি ও ক্যানসেল রেশিও সরাসরি অর্ডার পেইজে দেখতে পাবেন।" },
              { icon: "🚫", title: "ডুপ্লিকেট ও ফেক অর্ডার ব্লক", desc: "একই কাস্টমারের ডুপ্লিকেট অর্ডার, ওটিপি ভেরিফিকেশন এবং ভুয়া অর্ডার সিস্টেম অটোমেটিক ফিল্টার করে বাদ দিয়ে দেয়।" },
              { icon: "⚡", title: "এক ক্লিকে কুরিয়ারে এন্ট্রি", desc: "ম্যানুয়ালি ডাটা এন্ট্রি করার ঝামেলা শেষ। এক ক্লিকেই হাজার হাজার অর্ডার যেকোনো কুরিয়ার পোর্টালে সরাসরি আপলোড করুন।" },
              { icon: "📊", title: "১০০% নির্ভুল লাভ-ক্ষতি হিসাব", desc: "বিজ্ঞাপন খরচ, কুরিয়ার চার্জ এবং রিটার্ন ড্যামেজ হিসাব করে প্রতিটি প্রোডাক্টের আসল মুনাফা রিয়েল টাইমে মনিটর করুন।" },
              { icon: "🔌", title: "সহজ ওয়ার্ডপ্রেস প্লাগইন সেটআপ", desc: "যেকোনো WooCommerce সাইটের সাথে ২ মিনিটে প্লাগইনটি ইন্টিগ্রেট করুন। কোনো কোডিং অভিজ্ঞতার প্রয়োজন নেই।" },
              { icon: "💬", title: "অটোমেটেড কাস্টমার এসএমএস", desc: "অর্ডার কনফার্মেশন, শিপিং ও রিটার্ন অ্যালার্ট কাস্টমারকে স্বয়ংক্রিয়ভাবে পাঠিয়ে দিন এবং ক্যানসেলেশন কমিয়ে আনুন।" }
            ].map((feat) => (
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={idx} className="flex gap-3 text-xs sm:text-sm text-teal-100/90">
