      ...
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-16">
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: "🛡️", title: "রিয়েল-টাইম কুরিয়ার ফ্রড ডিটেকশন", desc: "কাস্টমারের ফোন নাম্বার দিয়ে Steadfast, Pathao, RedX সহ সকল কুরিয়ারের অতীত পার্সেল ডেলিভারি ও ক্যানসেল রেশিও সরাসরি WooCommerce সাইটে দেখতে পাবেন।" },
