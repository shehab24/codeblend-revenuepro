        ...
        <div className="p-6">
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden mt-6 shadow-sm">
                <div className="p-5 border-b border-slate-100 bg-slate-50/50">
                  <h3 className="text-sm font-bold text-slate-800 flex items-center gap-2">
                    <span className="p-1.5 bg-emerald-50 text-emerald-600 rounded-lg text-base">🔑</span>
                    মোবাইল অ্যাপ পাসওয়ার্ড (Mobile App Password)
                  </h3>
                  <p className="text-xs text-slate-400 mt-1">
                    মোবাইল অ্যাপে লগইন করার জন্য একটি পাসওয়ার্ড সেট বা পরিবর্তন করুন
                  </p>
                </div>
                  ...
                  <form onSubmit={handlePasswordUpdate} className="space-y-4 max-w-lg">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            placeholder="••••••••"
                            className="w-full pl-3 pr-10 py-2 rounded-xl border border-slate-200 bg-white text-slate-800 text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition"
                          />
                          <button
                            type="button"
                            onClick={() => setShowPassword(!showPassword)}
                            className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 bg-transparent border-none cursor-pointer outline-none p-0 flex items-center justify-center"
                          >
                            {showPassword ? (
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      <button
                        ...
                        className="px-5 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white text-xs font-bold rounded-xl shadow-md shadow-emerald-100 transition-all border-none cursor-pointer disabled:opacity-50 flex items-center gap-1.5"
                      >
                        {isUpdatingPassword ? (
                          <>
                    ...
                    {passwordMsg && (
                      <div className={`p-3 rounded-xl text-xs font-semibold flex items-center gap-2 mt-2 transition-all duration-300 ${passwordMsg.includes("সফলভাবে") ? "bg-emerald-50 text-emerald-700 border border-emerald-100" : "bg-red-50 text-red-700 border border-red-100"}`}>
                        <span>{passwordMsg.includes("সফলভাবে") ? "✅" : "⚠️"}</span>
